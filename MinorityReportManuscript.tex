...
\item `name of variety' change
\item `name of variety' apparent time
\end{itemize}

Where wildcards are not accepted in searches, the first two terms will be changed to: `name of variety' variation and `name of variety' sociolinguistics. Only a single term for each variety of English will be used in searches so as not to bias the variable `frequency of papers' in the process of literature searches.
